...
import com.parallel.master.TaskStatusListener;
...
public abstract class Task<T> implements Serializable {
    ...
    // 任务执行方法
    public abstract TaskResult<T> execute(TaskSplit<T> split);
    
    // 结果合并方法
    public abstract TaskResult<T> merge(List<TaskResult<T>> results);
